<!DOCTYPE html>
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="dark" style="--cp-left-dock: 0px">
    <head>
    ...
    <body class="min-h-screen bg-white dark:bg-zinc-800">
        ...
        <flux:header container class="border-b border-zinc-200 bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-900">
            ...
            <flux:navbar class="-mb-px max-lg:hidden">
                ...
                <flux:navbar.item icon="folder" :href="route('sites.index')" :current="request()->routeIs('sites.*')" wire:navigate>
                    {{ __('Sites') }}
                </flux:navbar.item>
            </flux:navbar>
