...
@if (($section['layout'] ?? 'grid') === 'carousel')
                @include('site.partials.carousel', [
                    'carouselItems' => $products,
                    'carouselItemView' => 'shop.partials.product-card',
                    'carouselItemVariable' => 'product',
                    'carouselItemExtra' => ['site' => $site],
                    'carouselLabel' => 'products',
                ])
@else            <div class="{{ $gridClass }}">
