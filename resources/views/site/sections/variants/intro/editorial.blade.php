{{-- Editorial intro: magazine longform. Full-width display heading,
     two-column prose, intro image recropped to a wide banner between
     intro and what follows. Same fields, same markers as classic. --}}
{{-- Bottom padding is deliberately tighter than the top: the numbered
     features section that follows in the editorial preset shares this
...
<div class="pt-20 lg:pt-24 pb-10 lg:pb-12" style="background-color: var(--color-surface);" data-svc-variant="editorial">
    <div class="site-shell-container px-4 sm:px-6 lg:px-8">
        ...
        @if (!empty($section['body']))
            <div @class([
                     'prose prose-lg max-w-none text-lg leading-relaxed md:columns-2 md:gap-14 [&>p]:mb-5',
