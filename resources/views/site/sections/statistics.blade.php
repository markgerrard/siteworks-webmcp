@php
    ...
    $eyebrow = $section['eyebrow'] ?? 'Key Figures';
@endphp
...
@php
    ...
    $svcVariantView = "site.sections.variants.statistics.{$svcVariant}";
    if (! view()->exists($svcVariantView)) {
        $svcVariantView = 'site.sections.variants.statistics.classic';
    }
@endphp
