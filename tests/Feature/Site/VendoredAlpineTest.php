...
test('public pages load alpine from the local vendor copy and not jsdelivr', function () {
    ...
    expect(public_path('vendor/alpine.min.js'))->toBeFile();
    expect(filesize(public_path('vendor/alpine.min.js')))->toBeGreaterThan(1000);
});
